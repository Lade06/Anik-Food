...
<div className="container">
    <div className="row">
        <div className="col-md-12">
            ...
            <img src={sushi} alt="" width={"100%"} className="mt-5" />
            <p className="text-center bold word mx-5"> Sushi Rolls</p>
            </div>

            <div className="intact">
            <img src={corndog} alt="" width={"100%"} className="mt-5" />
            <p className="text-center bold word">Cheesy Corn Dog</p>
            </div>

          <div className="intact">
          <img src={pizaa} alt="" width={"100%"} className="mt-5" />
        <p className="text-center bold word mx-5">Pizza</p>
          </div>

           <div className="intact">
           <img src={potatoebites} alt="" width={"100%"} className="mt-5"  />
